...
Guatemala.  Right on the fault that runs along The Americas, it has four active volcanoes and 37 in total.  The last spectacular eruption was in 2010 and the last tragic was in 2018.
...
suppressWarnings(gt_volcanoes %>% 
  leaflet() %>% 
  addTiles() %>% 
  addCircles(weight = 1, radius = sqrt(gt_volcanoes$alt)*70, color = "magenta" ), classes = "warning")
```
